  ...
  return (
    <section ref={ref} class="parallax-1">
      <div className="product-container">
        ...
        <FlippingCard heading="TechnaFeeder" frontText="TechnaFeeder" path={technafeeder} backText={<ul className="bulletlist">
      ...
      <li>Higher productivity by painting multiple workpieces at one time.</li>
        ...
        <div className="card-spacing" >
          <FlippingCard heading="Vertax & Horax" frontText="Vertax & Horax" path={vertax}  backText={<ul className="bulletlist">
        ...
        <div className="card-spacing">
          <FlippingCard heading="Technaslink" frontText="Technaslink" path={technaslink} backText={<ul className="bulletlist">
        ...
        <div className="card-spacing">
          <FlippingCard heading="Technaview (SCADA)" frontText="SCADA System - Technaview" path={scada} backText={<ul className="bulletlist">
        ...
        <div className="card-spacing">
          <FlippingCard heading="Bell Cleaner" path={bell} backText={<ul className="bulletlist">
        ...
        <div className="card-spacing">
          <FlippingCard heading="Pigging system" frontText="Pigging system" path={pigging} backText={<ul className="bulletlist">
        ...
        <div className="card-spacing">
          <FlippingCard heading="Dosing unit (FGP)" frontText="Dosing unit (FGP)" path={dozing} backText={<ul className="bulletlist">
        ...
        <div className="card-spacing">
          <FlippingCard heading="Colour Changing Unit" frontText="Colour Changing Unit" path={ccu} backText={<ul className="bulletlist">
